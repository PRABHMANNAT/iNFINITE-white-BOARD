...
const TOOLS: Array<{ id: Tool; label: string; icon: React.ComponentType<{ className?: string }>; group?: 'a' | 'b' | 'c' }> = [
  { id: 'select', label: 'Select (V)', icon: MousePointer2, group: 'a' },
  { id: 'pan', label: 'Pan (H)', icon: Hand, group: 'a' },

  { id: 'pen', label: 'Pen (P)', icon: Pencil, group: 'b' },
  { id: 'highlighter', label: 'Highlighter', icon: Highlighter, group: 'b' },
  { id: 'marker', label: 'Marker', icon: PenLine, group: 'b' },
  { id: 'eraser', label: 'Eraser (E)', icon: Eraser, group: 'b' },

  { id: 'rectangle', label: 'Rectangle (R)', icon: Square, group: 'c' },
  { id: 'ellipse', label: 'Ellipse (O)', icon: Circle, group: 'c' },
  { id: 'diamond', label: 'Diamond (D)', icon: Diamond, group: 'c' },
  { id: 'triangle', label: 'Triangle', icon: Triangle, group: 'c' },
  { id: 'line', label: 'Line (L)', icon: Minus, group: 'c' },
  { id: 'arrow', label: 'Arrow (A)', icon: ArrowRight, group: 'c' },
  { id: 'text', label: 'Text (T)', icon: Type, group: 'c' },
  { id: 'sticky', label: 'Sticky (S)', icon: StickyNote, group: 'c' },
];
